...
export const components: DocItem[] = [
  ...
  { slug: 'aspect-ratio', name: 'Aspect Ratio', description: 'Constrain media to a sketch frame ratio.', status: 'shipped', exportName: 'AspectRatio', installSnippet: "import { AspectRatio } from 'sketchpad-ui';" },
  ...
  { slug: 'button-group', name: 'Button Group', description: 'Grouped actions in a segmented sketch control.', status: 'shipped', exportName: 'ButtonGroup', installSnippet: "import { ButtonGroup } from 'sketchpad-ui';" },
  { slug: 'calendar', name: 'Calendar', description: 'Date grid with rough day cells.', status: 'shipped', exportName: 'Calendar', installSnippet: "import { Calendar } from 'sketchpad-ui';" },
  ...
  { slug: 'carousel', name: 'Carousel', description: 'Slideshow with sketch arrow navigation.', status: 'shipped', exportName: 'Carousel', installSnippet: "import { Carousel } from 'sketchpad-ui';" },
  { slug: 'chart', name: 'Chart', description: 'Simple charts on hand-drawn axes.', status: 'shipped', exportName: 'Chart', installSnippet: "import { Chart } from 'sketchpad-ui';" },
  ...
  { slug: 'context-menu', name: 'Context Menu', description: 'Right-click sketch menu.', status: 'shipped', exportName: 'ContextMenu', installSnippet: "import { ContextMenu } from 'sketchpad-ui';" },
  ...
  { slug: 'dialog', name: 'Dialog', description: 'Modal paper sheet over backdrop.', status: 'shipped', exportName: 'Dialog', installSnippet: "import { Dialog } from 'sketchpad-ui';" },
  ...
  { slug: 'scroll-area', name: 'Scroll Area', description: 'Custom sketch scrollbar.', status: 'shipped', exportName: 'ScrollArea', installSnippet: "import { ScrollArea } from 'sketchpad-ui';" },
  ...
  { slug: 'switch', name: 'Switch', description: 'Toggle switch with sketched knob.', status: 'shipped', exportName: 'Switch', installSnippet: "import { Switch } from 'sketchpad-ui';" },
