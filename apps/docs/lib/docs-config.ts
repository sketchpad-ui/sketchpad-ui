...
export const components: DocItem[] = [
  { slug: 'accordion', name: 'Accordion', description: 'Vertically stacked sections with sketch fold lines.', status: 'planned' },
  { slug: 'alert', name: 'Alert', description: 'Inline feedback banner with icon and message.', status: 'planned' },
  ...
  { slug: 'attachment', name: 'Attachment', description: 'File chip for chat and upload UIs.', status: 'new' },
  ...
  { slug: 'bubble', name: 'Bubble', description: 'Chat message container with sketch tail.', status: 'new' },
  ...
  { slug: 'card', name: 'Card', description: 'Paper sheet surface for grouped content.', status: 'partial', exportName: 'Paper', installSnippet: "import { Paper, StatCard } from 'sketchpad-ui';" },
  ...
  { slug: 'collapsible', name: 'Collapsible', description: 'Expand/collapse with sketch chevron.', status: 'planned' },
  ...
  { slug: 'field', name: 'Field', description: 'Label, control, and error as one unit.', status: 'partial', exportName: 'TextInput' },
  ...
  { slug: 'kbd', name: 'Kbd', description: 'Keyboard shortcut badge.', status: 'planned' },
  { slug: 'label', name: 'Label', description: 'Accessible form label.', status: 'partial' },
  { slug: 'marker', name: 'Marker', description: 'Read receipt or annotation dot.', status: 'new' },
  { slug: 'menubar', name: 'Menubar', description: 'Horizontal application menu bar.', status: 'planned' },
  { slug: 'message', name: 'Message', description: 'Chat message with avatar and meta.', status: 'new' },
  { slug: 'message-scroller', name: 'Message Scroller', description: 'Virtualized chat message list.', status: 'new' },
  ...
  { slug: 'spinner', name: 'Spinner', description: 'Loading indicator.', status: 'planned' },
